...
namespace RaspberryWinForms
{
    public partial class Form1 : Form
    {
        ...
        private async void AddProduct()
        {
            ...
            //Сохранить изображение - QR-код в желаемом месте
            ...
            save.FileName = String.Format("{0}/{1}", "C:/Users/1/Desktop/Прототипы малинки/19/Raspberry/Raspberry/wwwroot/qr_code_product/", "qr-"+p.Image);
            ...
            using (var client = new HttpClient())
            {
                ...
                if (result.IsSuccessStatusCode)
                {
                    ...
                    MessageBox.Show("Добавление в базу выполнено!!!");
                }
        ...
        private async void AddOrder()
        {
            ...
            SaveFileDialog save = new SaveFileDialog(); // save будет запрашивать у пользователя место, в которое он захочет сохранить файл. 
            save.Filter = "PNG|*.png|JPEG|*.jpg|GIF|*.gif|BMP|*.bmp";
            save.FileName = String.Format("{0}/{1}", "C:/Users/1/Desktop/Прототипы малинки/19/Raspberry/Raspberry/wwwroot/qr_code_order/", "qr-"+o.Image_product);
            picture.Image.Save(save.FileName);
